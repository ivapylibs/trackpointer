...
# test out codebase for processing marker movement.   The code below
#
# > fakeTri02
# > useMarkers = false;
# > fakeTri02
#
# runs the script twice.  The first time there is a moving set of three
# markers for each vertices in a triangle shape. They move rigidly together.  The second time
# there are no markers and the triangle is a solid shape.
#
#=============================== fakeTri02 ===============================
...
#
# Currently, x,y follow the Matlab coordinate system but not the OpenCV one
